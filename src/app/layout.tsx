...
export const metadata: Metadata = {
  title: "Classic Painting Decorating | Professional Painting Services in Australia",
  description: "Classic Painting Decorating is a professional painting services company that provides high-quality painting services to residential and commercial clients in Australia.",
};
